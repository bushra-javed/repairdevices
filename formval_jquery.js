$(function () {
    ...
    $('#form_firstname').on("keyup", check_firstname);
    $('#form_lastname').on("keyup", check_lastname);
    ...
    function enterpress(event) {
        ...
        if (event.which == 13) {
            ...
            // var nextspan = $(this).parent().next().find('span');
            console.log("this.parent.next.input", nextinput);
            console.log("this.parent.next.find(span)", $(this).parent().next().find('span'));
            // nextspan.hide('');
            nextinput.focus();
            var span1 = $(this).parent().next();
            console.log("this.parent.next", $(this).parent().next());
    ...
    function check_firstname() {
        ...
        // if ($(this).val().match('^[a-zA-Z]{3,16}$')) {
            ...
            span1.html('Please Enter Your First Name');
            span1.show();
...
function check_lastname() {
    ...
    // if ($(this).val().match('^[a-zA-Z]{3,16}$')) {
        ...
        span1.html('Please Enter Your Last Name');
        span1.show();
        error_username = true;
...
function check_username() {
    ...
    function check_email() {
        ...
        if (validateEmail(email)) {
            ...
            span1.html(email + " Enter valid email aa@ccc.bbb address:");
            span1.show();
            divp.addClass(' has-error');
    ...
    function check_retype_password() {
        ...
        if (password != re_password) {
            span1.html("plz Repeat the Password.");
            divp.addClass('has-error');
            //.css('color', 'red');
            span1.show();
            error_re_password = true;
